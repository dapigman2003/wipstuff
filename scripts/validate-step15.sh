...
if plist.get('CFBundleShortVersionString') != '0.0.43' or str(plist.get('CFBundleVersion')) != '43':
    raise SystemExit('ERROR: Step 15.1 must be version 0.0.43 (43).')
...
if 'Step 13 startup exception' in scene_delegate or 'Step 15 startup exception' not in scene_delegate:
    raise SystemExit('ERROR: Step 15 SceneDelegate startup telemetry is stale/mislabeled.')
...
print('Step 15.1 Godot Foundation preflight/stability source validation: PASS')
