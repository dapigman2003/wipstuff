...
{
  echo "Step 37.0.1 IPA verification passed."
  ...
  echo "  Expected device UI: STEP 37.0.1 — CONTROLLED GAME.TSCN ADMISSION AFTER PHYSICAL STEP-36 CLOSURE"
} | tee artifacts/logs/step37-ipa-verification-summary.log
