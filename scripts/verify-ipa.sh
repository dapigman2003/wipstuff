...
{
  echo "Step 41.0 IPA verification passed."
  ...
  echo "  Expected device UI: STEP 41.0 — GAMESTARTUP ASYNC FRONTIER MAP (NON-INVOKING)"
} | tee artifacts/logs/step41-ipa-verification-summary.log
