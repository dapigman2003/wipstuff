...
{
  echo "Steps 53–57 single-player submenu continuation IPA verification passed."
  ...
  echo "  Expected device UI: STEPS 53–57 — SINGLE-PLAYER SUBMENU CONTINUATION"
} | tee artifacts/logs/steps53-57-ipa-verification-summary.log
