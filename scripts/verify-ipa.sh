...
{
  echo "Steps 43–50 direct-main-menu ladder IPA verification passed."
  ...
  echo "  Expected device UI: STEPS 43–50 — DIRECT MAIN-MENU STARTUP LADDER"
} | tee artifacts/logs/steps43-50-ipa-verification-summary.log
