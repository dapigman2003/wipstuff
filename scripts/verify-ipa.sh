...
{
  echo "Step 42.0 IPA verification passed."
  ...
  echo "  Expected device UI: STEP 42.0 — CONTROLLED GAMESTARTUP INITPOOLS"
} | tee artifacts/logs/step42-ipa-verification-summary.log
