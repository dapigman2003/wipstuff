...
{
  echo "Step 38.0.1 IPA verification passed."
  ...
  echo "  Expected device UI: STEP 38.0.1 — CONTROLLED NGAME _ENTERTREE AFTER PHYSICAL STEP-37 CLOSURE"
} | tee artifacts/logs/step38-ipa-verification-summary.log
