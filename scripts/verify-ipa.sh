...
{
  echo "Step 40.0 IPA verification passed."
  ...
  echo "  Expected device UI: STEP 40.0 — CONTROLLED REAL-GAME RENDER PULSE"
} | tee artifacts/logs/step40-ipa-verification-summary.log
