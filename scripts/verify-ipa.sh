...
{
  echo "Step 39.0 IPA verification passed."
  ...
  echo "  Expected device UI: STEP 39.1 — GATE-B LIFECYCLE COMPATIBILITY"
} | tee artifacts/logs/step39-ipa-verification-summary.log
