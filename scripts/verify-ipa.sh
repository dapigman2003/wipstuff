...
{
  echo "Step 36.0.1 IPA verification passed."
  ...
  echo "  Expected device UI: STEP 35.0.31 / STEP 36.0.1 — EXACT GAME RESOURCE-PACK HANDOFF + CONTROLLED EXECUTEESSENTIAL"
} | tee artifacts/logs/step36-ipa-verification-summary.log
