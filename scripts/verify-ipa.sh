...
{
  echo "Steps 43–47 startup-ladder IPA verification passed."
  ...
  echo "  Expected device UI: STEPS 43–47 — SEQUENTIAL STARTUP LADDER"
} | tee artifacts/logs/steps43-47-ipa-verification-summary.log
