...
{
  echo "Steps 43–52 physically closed stabilization IPA verification passed."
  ...
  echo "  Expected device UI: STEPS 43–52 — PHYSICALLY CLOSED STABILIZATION"
} | tee artifacts/logs/steps43-52-ipa-verification-summary.log
