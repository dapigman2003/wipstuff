...
IPA="$ROOT/artifacts/StS2-Launcher-Step-12.2.1.ipa"
...
echo "Restoring Step 12.2.1 projects into isolated NuGet package root..."
...
{
  echo "=== Step 12.2.1 SteamKit iOS compatibility patch ==="
...
echo "Publishing Step 12.2.1 catch-order-compile-hotfix build..."
set +e
...
if [[ "$PUBLISH_STATUS" != "0" ]]; then
  echo "=== Step 12.2.1 publish failed: focused scan ===" \
...
(
  cd artifacts
  rm -f StS2-Launcher-Step-12.2.1.ipa
  /usr/bin/zip -qry StS2-Launcher-Step-12.2.1.ipa Payload
)
