...
IPA="$ROOT/artifacts/StS2-Launcher-Step-12.3.ipa"
...
echo "Restoring Step 12.3 projects into isolated NuGet package root..."
...
{
  echo "=== Step 12.3 SteamKit iOS compatibility patch ==="
...
echo "Publishing Step 12.3 verified-cache-update-test build..."
set +e
...
if [[ "$PUBLISH_STATUS" != "0" ]]; then
  echo "=== Step 12.3 publish failed: focused scan ===" \
...
(
  cd artifacts
  rm -f StS2-Launcher-Step-12.3.ipa
  /usr/bin/zip -qry StS2-Launcher-Step-12.3.ipa Payload
)
