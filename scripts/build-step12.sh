...
IPA="$ROOT/artifacts/StS2-Launcher-Step-12.4.ipa"
...
echo "Restoring Step 12.4 projects into isolated NuGet package root..."
...
{
  echo "=== Step 12.4 SteamKit iOS compatibility patch ==="
...
echo "Publishing Step 12.4 post-Step-12 stabilization build..."
set +e
...
if [[ "$PUBLISH_STATUS" != "0" ]]; then
  echo "=== Step 12.4 publish failed: focused scan ===" \
...
(
  cd artifacts
  rm -f StS2-Launcher-Step-12.4.ipa
  /usr/bin/zip -qry StS2-Launcher-Step-12.4.ipa Payload
)
