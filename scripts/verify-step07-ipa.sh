...
IPA="${1:-artifacts/StS2-Launcher-Step-07.ipa}"
...
[[ "$VERSION" == "0.0.28" ]] || { echo "ERROR: wrong Step 07 version: $VERSION" >&2; exit 4; }
[[ "$BUILD_VERSION" == "28" ]] || { echo "ERROR: wrong Step 07 build version: $BUILD_VERSION" >&2; exit 4; }
...
echo "Step 07 IPA verification passed."
echo "  Bundle ID: $BUNDLE_ID"
echo "  Version: $VERSION ($BUILD_VERSION)"
echo "  Architecture: arm64"
echo "  Expected device UI: STEP 07 — OWNERSHIP VERIFICATION"
