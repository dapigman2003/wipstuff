...
IPA="${1:-artifacts/StS2-Launcher-Step-06.3.1.ipa}"
...
[[ "$VERSION" == "0.0.27" ]] || { echo "ERROR: wrong Step 06.3.1 version: $VERSION" >&2; exit 4; }
[[ "$BUILD_VERSION" == "27" ]] || { echo "ERROR: wrong Step 06.3.1 build version: $BUILD_VERSION" >&2; exit 4; }
...
echo "Step 06.3.1 IPA verification passed."
echo "  Bundle ID: $BUNDLE_ID"
echo "  Version: $VERSION ($BUILD_VERSION)"
echo "  Architecture: arm64"
echo "  Expected device UI: STEP 06.3.1 — PERSISTENT SESSION FIX"
