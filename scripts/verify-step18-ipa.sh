...
[[ "$VERSION" == "0.0.47" ]] || { echo "ERROR: wrong Step 18 version: $VERSION" >&2; exit 4; }
[[ "$BUILD_VERSION" == "47" ]] || { echo "ERROR: wrong Step 18 build version: $BUILD_VERSION" >&2; exit 4; }
...

{
  ...
  echo "  Expected device UI: STEP 18 — REAL ASSEMBLY REWRITE WORKSPACE"
