...
[[ "$VERSION" == "0.0.49" ]] || { echo "ERROR: wrong Step 18 version: $VERSION" >&2; exit 4; }
[[ "$BUILD_VERSION" == "49" ]] || { echo "ERROR: wrong Step 18 build version: $BUILD_VERSION" >&2; exit 4; }
...

{
  ...
  echo "  Expected device UI: STEP 18.2 — REAL ASSEMBLY REWRITE WORKSPACE"
