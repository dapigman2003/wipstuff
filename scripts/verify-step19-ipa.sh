...
[[ "$VERSION" == "0.0.52" ]] || { echo "ERROR: wrong Step 19 version: $VERSION" >&2; exit 4; }
[[ "$BUILD_VERSION" == "52" ]] || { echo "ERROR: wrong Step 19 build version: $BUILD_VERSION" >&2; exit 4; }
...

{
  ...
  echo "  Expected device UI: STEP 19 — EXPRESSION INTERPRETER COMPATIBILITY"
