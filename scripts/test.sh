...
echo "StS2 Launcher — Steps 58–62 real character-select ownership / visible-render trial host regression tests"
...
dotnet test "$TEST_PROJECT" \
  ...
  --logger "trx;LogFileName=steps43-52.trx" \
  --logger "console;verbosity=normal"

echo "HOST UNIT TESTS: PASS"
echo "TRX: artifacts/test-results/steps43-52.trx"
