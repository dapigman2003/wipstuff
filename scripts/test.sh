...
echo "StS2 Launcher — Steps 43–50 direct-main-menu ladder host regression tests"
...
dotnet test "$TEST_PROJECT" \
  ...
  --logger "trx;LogFileName=steps43-50.trx" \
  --logger "console;verbosity=normal"

echo "HOST UNIT TESTS: PASS"
echo "TRX: artifacts/test-results/steps43-50.trx"
