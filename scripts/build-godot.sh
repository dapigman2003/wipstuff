...

{
  ...
  echo "Godot native C#/.NET module: enabled for Step-35.0.22 reverse-binding readiness + runtime interop callback-table exposure (managed Godot assemblies are not built here)"
  echo "Metal: enabled"
