...

{
  ...
  echo "Godot native C#/.NET module: enabled for Step-35.0.24 managed-plugin bridge + post-bootstrap resolver-baseline validation + runtime interop callback-table exposure (managed Godot assemblies are not built here)"
  echo "Metal: enabled"
