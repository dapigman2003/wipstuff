...
IPA="${1:-artifacts/StS2-Launcher-Step-14.ipa}"
...
[[ "$VERSION" == "0.0.41" ]] || { echo "ERROR: wrong Step 14 version: $VERSION" >&2; exit 4; }
[[ "$BUILD_VERSION" == "41" ]] || { echo "ERROR: wrong Step 14 build version: $BUILD_VERSION" >&2; exit 4; }
...
echo "Step 14 IPA verification passed."
echo "  Bundle ID: $BUNDLE_ID"
echo "  Version: $VERSION ($BUILD_VERSION)"
echo "  Architecture: arm64"
echo "  Expected device UI: STEP 14 — COMPATIBILITY INVENTORY"
