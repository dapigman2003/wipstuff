...
# Step 15 remains available as a regression boundary in Step 16.
...
# Step 16 fixture is inert project-owned managed test data. It is deliberately
...
# Mono.Cecil is now an intentional runtime dependency for Step 16. The project-
...
cp "$DEPENDENCIES" artifacts/logs/step16-final-native-dependencies.log
...
# physical Step 16 Cecil gates are the authoritative managed-runtime checks.
...
{
  echo "Step 16 IPA verification passed."
  echo "  Bundle ID: $BUNDLE_ID"
  echo "  Version: $VERSION ($BUILD_VERSION)"
  echo "  Architecture: arm64"
  echo "  Godot 4.5.1 Step 15 regression host: retained"
  echo "  Mono.Cecil 0.11.6 managed-preparation dependency: linked/AOT input"
