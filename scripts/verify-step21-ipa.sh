...
[[ "$VERSION" == "0.0.56" ]] || { echo "ERROR: wrong Step 21 version: $VERSION" >&2; exit 4; }
[[ "$BUILD_VERSION" == "56" ]] || { echo "ERROR: wrong Step 21 build version: $BUILD_VERSION" >&2; exit 4; }
...
cp "$DEPENDENCIES" artifacts/logs/step21-final-native-dependencies.log
...
{
  echo "Step 21 IPA verification passed."
  ...
  echo "  Expected device UI: STEP 21 — PREPARED RUNTIME / FRAMEWORK BINDING"
} | tee artifacts/logs/step21-ipa-verification-summary.log
