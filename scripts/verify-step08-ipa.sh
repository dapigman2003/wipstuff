...
IPA="${1:-artifacts/StS2-Launcher-Step-08.ipa}"
...
[[ "$VERSION" == "0.0.29" ]] || { echo "ERROR: wrong Step 08 version: $VERSION" >&2; exit 4; }
[[ "$BUILD_VERSION" == "29" ]] || { echo "ERROR: wrong Step 08 build version: $BUILD_VERSION" >&2; exit 4; }
...
echo "Step 08 IPA verification passed."
echo "  Bundle ID: $BUNDLE_ID"
echo "  Version: $VERSION ($BUILD_VERSION)"
echo "  Architecture: arm64"
echo "  Expected device UI: STEP 08 — DEPOT / MANIFEST DISCOVERY"
