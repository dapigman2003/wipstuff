...
IPA="${1:-artifacts/StS2-Launcher-Step-10.ipa}"
...
[[ "$VERSION" == "0.0.31" ]] || { echo "ERROR: wrong Step 10 version: $VERSION" >&2; exit 4; }
[[ "$BUILD_VERSION" == "31" ]] || { echo "ERROR: wrong Step 10 build version: $BUILD_VERSION" >&2; exit 4; }
...
echo "Step 10 IPA verification passed."
echo "  Bundle ID: $BUNDLE_ID"
echo "  Version: $VERSION ($BUILD_VERSION)"
echo "  Architecture: arm64"
echo "  Expected device UI: STEP 10 — MINIMAL FULL-DEPOT DOWNLOADER"
