...
IPA="${1:-artifacts/StS2-Launcher-Step-09.ipa}"
...
[[ "$VERSION" == "0.0.30" ]] || { echo "ERROR: wrong Step 09 version: $VERSION" >&2; exit 4; }
[[ "$BUILD_VERSION" == "30" ]] || { echo "ERROR: wrong Step 09 build version: $BUILD_VERSION" >&2; exit 4; }
...
echo "Step 09 IPA verification passed."
echo "  Bundle ID: $BUNDLE_ID"
echo "  Version: $VERSION ($BUILD_VERSION)"
echo "  Architecture: arm64"
echo "  Expected device UI: STEP 09 — ONE CONTROLLED SMALL FILE"
