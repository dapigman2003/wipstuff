...
{
  echo "StS2 Launcher — Step 35.0.21 Godot Singleton Acquisition Localization build environment"
  date -u
  uname -a
  xcodebuild -version
...
{
  echo "StS2 Launcher iOS — Step 35.0.21 Godot Singleton Acquisition Localization"
  echo "UTC: $(date -u '+%Y-%m-%dT%H:%M:%SZ')"
