...
{
  echo "StS2 Launcher — Step 35.0.9 Null-Platform Constructor Callsite Localization build environment"
  date -u
  uname -a
  xcodebuild -version
...
{
  echo "StS2 Launcher iOS — Step 35.0.9 Null-Platform Constructor Callsite Localization"
  echo "UTC: $(date -u '+%Y-%m-%dT%H:%M:%SZ')"
