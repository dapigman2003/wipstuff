...
{
  echo "StS2 Launcher — Step 35.0.7 In-Method Pre-First-Await Localization build environment"
  date -u
  uname -a
  xcodebuild -version
...
{
  echo "StS2 Launcher iOS — Step 35.0.7 In-Method Pre-First-Await Localization"
  echo "UTC: $(date -u '+%Y-%m-%dT%H:%M:%SZ')"
