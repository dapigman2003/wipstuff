...
{
  echo "StS2 Launcher — Step 27 Controlled Launcher-Owned Harmony Patch + Unpatch Boundary build environment"
  date -u
  uname -a
  xcodebuild -version
...
{
  echo "StS2 Launcher iOS — Step 27 Controlled Launcher-Owned Harmony Patch + Unpatch Boundary"
