...
{
  echo "StS2 Launcher — Step 38.2 iOS/off-tree-compatible NGame _EnterTree build environment"
  date -u
  uname -a
  xcodebuild -version
...
{
  echo "StS2 Launcher iOS — Step 38.2 iOS/off-tree-compatible NGame _EnterTree"
  echo "UTC: $(date -u '+%Y-%m-%dT%H:%M:%SZ')"
