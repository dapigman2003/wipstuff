...
{
  echo "StS2 Launcher — Step 35.0.25 Host Regression Contract Correction build environment"
  date -u
  uname -a
  xcodebuild -version
...
{
  echo "StS2 Launcher iOS — Step 35.0.25 Host Regression Contract Correction"
  echo "UTC: $(date -u '+%Y-%m-%dT%H:%M:%SZ')"
