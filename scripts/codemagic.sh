...
{
  echo "StS2 Launcher — Step 29 Real StS2 Compatibility Target Audit build environment"
  date -u
  uname -a
  xcodebuild -version
...
{
  echo "StS2 Launcher iOS — Step 29 Real StS2 Compatibility Target Audit Boundary"
