...
{
  echo "StS2 Launcher — Step 28 Ahead-of-Load Managed Transformation build environment"
  date -u
  uname -a
  xcodebuild -version
...
{
  echo "StS2 Launcher iOS — Step 28 Ahead-of-Load Managed Transformation Boundary"
