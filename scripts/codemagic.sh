...
{
  echo "StS2 Launcher — Codemagic cache state before Steps 43–50 direct-main-menu ladder build"
...
{
  echo "StS2 Launcher — Steps 43–50 direct main-menu startup ladder build environment"
  date -u
  uname -a
  xcodebuild -version
...
{
  echo "StS2 Launcher iOS — Steps 43–50 direct main-menu startup ladder"
  echo "UTC: $(date -u '+%Y-%m-%dT%H:%M:%SZ')"
