...
{
  echo "StS2 Launcher — Step 22.3 Foundation Consolidation build environment"
  date -u
  uname -a
  xcodebuild -version
...
{
  echo "StS2 Launcher iOS — Step 22.3 Foundation Consolidation"
  ...
  echo "IPA: artifacts/StS2-Launcher-Step-22.3.ipa"
  echo "IPA SHA-256: $(shasum -a 256 artifacts/StS2-Launcher-Step-22.3.ipa | awk '{print $1}')"
