...
{
  echo "StS2 Launcher — Step 35.0.32 / Step 36.0.3 ModelDb Bootstrap Compatibility + Full ExecuteEssential build environment"
  date -u
  uname -a
  xcodebuild -version
...
{
  echo "StS2 Launcher iOS — Step 35.0.32 / Step 36.0.3 ModelDb Bootstrap Compatibility + Full ExecuteEssential"
  echo "UTC: $(date -u '+%Y-%m-%dT%H:%M:%SZ')"
