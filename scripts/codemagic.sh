...
{
  echo "StS2 Launcher — Step 26 Controlled Empty Harmony PatchProcessor Creation Boundary build environment"
  date -u
  uname -a
  xcodebuild -version
...
{
  echo "StS2 Launcher iOS — Step 26 Controlled Empty Harmony PatchProcessor Creation Boundary"
