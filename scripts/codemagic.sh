...
{
  echo "StS2 Launcher — Step 32 First Real StS2 PrepareMethod Rewrite build environment"
  date -u
  uname -a
  xcodebuild -version
...
{
  echo "StS2 Launcher iOS — Step 32 First Real StS2 PrepareMethod Rewrite Boundary"
