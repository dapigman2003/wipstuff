...
{
  echo "StS2 Launcher — Step 38.0.1 Controlled NGame _EnterTree Entry build environment"
  date -u
  uname -a
  xcodebuild -version
...
{
  echo "StS2 Launcher iOS — Step 38.0.1 Controlled NGame _EnterTree Entry"
  echo "UTC: $(date -u '+%Y-%m-%dT%H:%M:%SZ')"
