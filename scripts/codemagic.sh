...
{
  echo "StS2 Launcher — Step 35.0.27 Exact Authority Closure + Gate D Finalization build environment"
  date -u
  uname -a
  xcodebuild -version
...
{
  echo "StS2 Launcher iOS — Step 35.0.27 Exact Authority Closure + Gate D Finalization"
  echo "UTC: $(date -u '+%Y-%m-%dT%H:%M:%SZ')"
