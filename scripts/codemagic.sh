...
{
  echo "StS2 Launcher — Step 35.0.24 Post-Bootstrap Resolver Baseline build environment"
  date -u
  uname -a
  xcodebuild -version
...
{
  echo "StS2 Launcher iOS — Step 35.0.24 Post-Bootstrap Resolver Baseline"
  echo "UTC: $(date -u '+%Y-%m-%dT%H:%M:%SZ')"
