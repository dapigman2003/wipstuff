...
{
  echo "StS2 Launcher — Step 35.0.18 Godot Core Callback-Handoff Probe build environment"
  date -u
  uname -a
  xcodebuild -version
...
{
  echo "StS2 Launcher iOS — Step 35.0.18 Godot Core Callback-Handoff Probe"
  echo "UTC: $(date -u '+%Y-%m-%dT%H:%M:%SZ')"
