...
require("<ApplicationVersion>104</ApplicationVersion>" in project_text, "build version is 104")
require("<ApplicationDisplayVersion>0.0.104</ApplicationDisplayVersion>" in project_text, "display version is 0.0.104")
require(plist.get("CFBundleVersion") == "104", "Info.plist build version is 104")
require(plist.get("CFBundleShortVersionString") == "0.0.104", "Info.plist display version is 0.0.104")
...
require("STEP 27.0.20 — HASH-PINNED REAL-HARMONY NORMALIZER EXECUTION" in release_presentation, "top launcher banner identifies active Step 27.0.20 candidate")
require("0.0.103" in release_presentation and "212 host tests" in release_presentation and "211" in release_presentation and "multiple System.Runtime AssemblyRef" in release_presentation and "SHA-256" in release_presentation and "production Deferred-Cecil normalizer" in release_presentation and "No StS2 member" in release_presentation, "top launcher banner records the 0.0.103 duplicate-AssemblyRef failure and scopes the 0.0.104 content-addressed correction")
...
require('ExpectedDisplayVersion = "0.0.104"' in release_presentation and 'ExpectedBuildVersion = "104"' in release_presentation, "Step 27.0.20 source pins expected bundle release identity")
...
for key, value in {
    ...
    "STS2_DISPLAY_VERSION": "0.0.104",
    "STS2_BUILD_VERSION": "104",
...
require("Steps 01–26" in current_status and "0.0.89 (89)" in current_status and "0.0.90 (90)" in current_status and "0.0.93 (93)" in current_status and "0.0.94 (94)" in current_status and "0.0.97 (97)" in current_status and "EditorBrowsableState" in current_status and "ReadingMode.Deferred" in current_status and "0.0.102 (102)" in current_status and "0.0.103 (103)" in current_status and "Sequence contains more than one matching element" in current_status and "a5fc5f9d9640b927d786a0527faa18bf7aa776788235140c59e9b73de87a7774" in current_status and "a849b726e1f9248d71aabbed8114deaf79beb7acc25e8344ff92a27ad8ac87ab" in current_status and "Step 27.0.20 / 0.0.104 (104)" in current_status and "net9.0/0Harmony.dll" in current_status and "merged AssemblyRef" in current_status and "post-publish interpreted fixture" in current_status and "ahead-of-load Cecil" in current_status and "T6" in current_status and "T7/T8" in current_status and "Step27-CrashCheckpoint.txt" in current_status and "Force-quit/relaunch before every Step-27 retry" in current_status and "26/26 PASS" in current_status and "Step 28" in current_status, "current status preserves Step 27 evidence and advances to Step 27.0.20 / 0.0.104 hash-pinned real-Harmony normalizer execution")
