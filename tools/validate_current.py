...
require("<ApplicationVersion>101</ApplicationVersion>" in project_text, "build version is 101")
require("<ApplicationDisplayVersion>0.0.101</ApplicationDisplayVersion>" in project_text, "display version is 0.0.101")
require(plist.get("CFBundleVersion") == "101", "Info.plist build version is 101")
require(plist.get("CFBundleShortVersionString") == "0.0.101", "Info.plist display version is 0.0.101")
...
require("STEP 27.0.17 — HARMONY FAT ARCHIVE MEMBER DISCOVERY HARDENING" in release_presentation, "top launcher banner identifies active Step 27.0.17 candidate")
require("Physical 0.0.97" in release_presentation and "ReadingMode.Immediate" in release_presentation and "Deferred" in release_presentation and "0.0.100" in release_presentation and "archive" in release_presentation and "Harmony-Fat.2.4.2.0" in release_presentation and "/netstandard2.0/0Harmony.dll" in release_presentation and "No StS2 member" in release_presentation, "top launcher banner preserves Deferred-Cecil evidence and describes wrapped Harmony-Fat member discovery")
...
require('ExpectedDisplayVersion = "0.0.101"' in release_presentation and 'ExpectedBuildVersion = "101"' in release_presentation, "Step 27.0.17 source pins expected bundle release identity")
...
for key, value in {
    ...
    "STS2_DISPLAY_VERSION": "0.0.101",
    "STS2_BUILD_VERSION": "101",
...
require('reference.Name == "netstandard"' in step27_tests and 'new Version(2, 0, 0, 0)' in step27_tests, "Step 27.0.17 real-Harmony fixture pins the netstandard 2.0 assembly-reference profile observed on-device")
...
require("Steps 01–26" in current_status and "0.0.89 (89)" in current_status and "0.0.90 (90)" in current_status and "0.0.93 (93)" in current_status and "0.0.94 (94)" in current_status and "0.0.95 (95)" in current_status and "0.0.96 (96)" in current_status and "209 passed" in current_status and "0.0.97 (97)" in current_status and "EditorBrowsableState" in current_status and "ReadingMode.Immediate" in current_status and "ReadingMode.Deferred" in current_status and "0.0.98 (98)" in current_status and "ICustomAttributeProvider" in current_status and "CS0104" in current_status and "0.0.99 (99)" in current_status and "StS2Launcher.Core.Tests" in current_status and "NuGetPackageRoot" in current_status and "0.0.100 (100)" in current_status and "found zero" in current_status and "Step 27.0.17 / 0.0.101 (101)" in current_status and "Harmony-Fat.2.4.2.0" in current_status and "/netstandard2.0/0Harmony.dll" in current_status and "STS2_STEP27_REAL_HARMONY_FIXTURE" in current_status and "post-publish interpreted fixture" in current_status and "ahead-of-load Cecil" in current_status and "T6" in current_status and "T7/T8" in current_status and "Step27-CrashCheckpoint.txt" in current_status and "Force-quit/relaunch before every Step-27 retry" in current_status and "26/26 PASS" in current_status and "Step 28" in current_status, "current status preserves Step 27 evidence and advances to Step 27.0.17 / 0.0.101 strict Harmony-Fat archive-member discovery")
