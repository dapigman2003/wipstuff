...
**Step 18.1 does not apply a behaviorally significant compatibility fix and does not load or execute StS2 assemblies. Cecil writer-required resolution is restricted to the SHA-1-verified launcher-private Step 18 workspace; runtime/system/live-install/network fallback is forbidden.**
