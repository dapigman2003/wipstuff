...
**Current source candidate:** Step 16.1 — Managed Preparation Foundation hotfix after physical Gates A–C passed and Gate D exposed duplicate architecture-specific `sts2.dll` copies.

- App version: `0.0.45 (45)`
...
D. re-prove OfflineReady and inspect real receipt-backed StS2 managed metadata read-only, selecting the macOS arm64 `sts2.dll` when both arm64 and x86_64 copies exist.
