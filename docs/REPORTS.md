...
## Step 38.0.1 current evidence contract
...
Step 38.0.1 requires that same-process Step-37 closure before Gate A. Preserve `Step38-CrashCheckpoint-<RunId>.txt`, `Step38-NGameLifecycle-StaticMap-<RunId>.txt`, `Step38-LastCheckpoint.txt`, and `Step38-TransformedRealStS2NGameLifecycleEntry.txt`, along with prerequisite Step35/Step36/Step37 reports.
