...
## Step 37.0.1 current evidence contract
...
Step 37.0.1 requires that same-process closure before Gate A. Preserve `Step37-CrashCheckpoint-<RunId>.txt`, `Step37-GameScene-StaticMap-<RunId>.txt`, `Step37-LastCheckpoint.txt`, and `Step37-TransformedRealStS2GameSceneAdmission.txt`, along with the prerequisite Step35/Step36 reports.
