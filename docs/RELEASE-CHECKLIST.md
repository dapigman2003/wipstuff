# Release checklist — Step 35.0.11

Release identity:

- display/build: `0.0.134 (134)`
- IPA: `StS2-Launcher-Step-35.ipa`
- active workflow: `ios-canonical`

Before handing off/building:

- [ ] release identity is exactly `0.0.134 (134)` in csproj, Info.plist, shell release constants, UI source, testing docs and this checklist;
