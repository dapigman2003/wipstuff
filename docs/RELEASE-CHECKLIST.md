# Release checklist — Steps 43–47 / 0.0.177

Release identity: display/build `0.0.177 (177)`, IPA `StS2-Launcher-Steps-43-47.ipa`, workflow `ios-canonical`.
...
Require exact version/build 0.0.177/177 in csproj/plist/release presentation/current-release shell constants; Codemagic/host-test/IPA-verifier headings and filenames updated to Steps 43–47; active manifests regenerated; no proprietary StS2/native payload; final ZIP integrity clean; and canonical validator green again from a completely fresh extraction.
