...
Candidate 0.0.190 packages seven separately gated rungs on top of physically closed Step-57 authority. The design follows the exact Step-56 `OpenCharacterSelect(NButton)` IL but does **not** invoke that handler.
