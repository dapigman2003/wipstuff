...
- `reports/STEP-27.0.1-PHYSICAL-GATE-O-REPORT.txt` — physical 0.0.85 failed safely 14/26 at Gate O; no AccessTools execution occurred, and the report exposed the real 56-instruction runtime-detection/cache initializer.
