...
- `steps/STEP-27.0.3-ACCESSTOOLS-PHYSICAL-FINGERPRINT-CORRECTION.md` — 0.0.87 pins the corrected 57-instruction AccessTools fingerprint semantically (first RuntimeInformation Type.GetType throwOnError=true, second=false) and fixes/enforces the top-of-app current release presentation.
