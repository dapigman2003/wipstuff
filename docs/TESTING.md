...
`artifacts/StS2-Launcher-Step-23.4.2.ipa`

## IPA verification

```sh
bash scripts/verify-ipa.sh artifacts/StS2-Launcher-Step-23.4.2.ipa
```
...
Install version `0.0.71` and start from a fresh process. Do not start the Step 15 Godot host first.
