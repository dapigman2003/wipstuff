...
Active candidate: `0.0.163 (163)`, IPA `StS2-Launcher-Step-38.ipa`, workflow `ios-canonical`.
...
Physical sequence: fresh process -> Step 15 A-C -> Step 35 MODEL-BOOTSTRAP 4/4 -> Step 36.0.5 4/4 -> Step 37.0.1 4/4 -> Step 38.0.1 A-D once. Use a fresh process after any Gate-C-started failure.
