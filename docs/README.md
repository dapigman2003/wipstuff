# StS2 Launcher — Step 38.0.1

Active candidate: **0.0.163 (163)** — controlled `NGame._EnterTree()` execution after physical Step-37 closure.
...
5. Step 38.0.1 Gates A-D once. If Gate C begins and fails, use a fresh process before retry.
