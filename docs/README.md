# StS2 Launcher — Step 37.0

Active candidate: **0.0.160 (160)** — controlled `game.tscn` admission after physical Step-36 closure.
...
4. Step 37.0 Gates A-D once. If Gate C or D begins and fails, use a fresh process before retry.
