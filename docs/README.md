...
Active candidate: **0.0.196 (196)**. Physical authority is closed through Step 57. Physical **0.0.194** proved the retained single-player submenu was already logically bound and the real standard button was supplied before original `OpenCharacterSelect`, yet the original handler still threw `NullReferenceException`.
