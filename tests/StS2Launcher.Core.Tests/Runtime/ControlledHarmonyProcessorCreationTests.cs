...
[TestClass]
[DoNotParallelize]
public sealed class ControlledHarmonyProcessorCreationTests
{
    [TestMethod]
    public void OrderedHarmonyProcessorCreationGatesReachFourteenOfFourteenPass()
    {
        var gates = new ControlledHarmonyProcessorCreationGateSequence();
        gates.Record(new ControlledHarmonyProcessorCreationGateResult(ControlledHarmonyProcessorCreationGate.InitializationPreflight, true, "preflight"));
        gates.Record(new ControlledHarmonyProcessorCreationGateResult(ControlledHarmonyProcessorCreationGate.ProvenLoadStateReplay, true, "replay"));
        gates.Record(new ControlledHarmonyProcessorCreationGateResult(ControlledHarmonyProcessorCreationGate.DeferredModuleInitialization, true, "initialize"));
        gates.Record(new ControlledHarmonyProcessorCreationGateResult(ControlledHarmonyProcessorCreationGate.ProvenInitializationAudit, true, "audit"));
        gates.Record(new ControlledHarmonyProcessorCreationGateResult(ControlledHarmonyProcessorCreationGate.HarmonyApiResolution, true, "resolve"));
        gates.Record(new ControlledHarmonyProcessorCreationGateResult(ControlledHarmonyProcessorCreationGate.HarmonyTypeInitialization, true, "type initialize"));
        gates.Record(new ControlledHarmonyProcessorCreationGateResult(ControlledHarmonyProcessorCreationGate.HarmonyTypeInitializationAudit, true, "type-init audit"));
        gates.Record(new ControlledHarmonyProcessorCreationGateResult(ControlledHarmonyProcessorCreationGate.HarmonyInstanceConstruction, true, "construct"));
        gates.Record(new ControlledHarmonyProcessorCreationGateResult(ControlledHarmonyProcessorCreationGate.PostConstructionAudit, true, "Step 25 replay audit"));
        gates.Record(new ControlledHarmonyProcessorCreationGateResult(ControlledHarmonyProcessorCreationGate.HarmonyProcessorApiResolution, true, "processor API"));
        gates.Record(new ControlledHarmonyProcessorCreationGateResult(ControlledHarmonyProcessorCreationGate.PatchProcessorTypeInitialization, true, "processor type init"));
        gates.Record(new ControlledHarmonyProcessorCreationGateResult(ControlledHarmonyProcessorCreationGate.LauncherProbeResolution, true, "launcher probe"));
        gates.Record(new ControlledHarmonyProcessorCreationGateResult(ControlledHarmonyProcessorCreationGate.HarmonyProcessorCreation, true, "processor create"));
        gates.Record(new ControlledHarmonyProcessorCreationGateResult(ControlledHarmonyProcessorCreationGate.PostProcessorAudit, true, "processor audit"));

        var summary = gates.Snapshot();
        Assert.IsTrue(summary.Passed);
        Assert.AreEqual(14, summary.PassedGates);
        Assert.AreEqual("CONTROLLED HARMONY PROCESSOR CREATION BOUNDARY PASS — 14/14", summary.Summary);
    }

    [TestMethod]
    public void HarmonyProcessorCreationGatesStopAfterFirstFailure()
    {
        var gates = new ControlledHarmonyProcessorCreationGateSequence();
        gates.Record(new ControlledHarmonyProcessorCreationGateResult(ControlledHarmonyProcessorCreationGate.InitializationPreflight, true, "preflight"));
        gates.Record(new ControlledHarmonyProcessorCreationGateResult(ControlledHarmonyProcessorCreationGate.ProvenLoadStateReplay, false, "replay failed"));
        Assert.ThrowsExactly<InvalidOperationException>(() =>
            gates.Record(new ControlledHarmonyProcessorCreationGateResult(ControlledHarmonyProcessorCreationGate.DeferredModuleInitialization, true, "must not advance")));
        Assert.AreEqual(ControlledHarmonyProcessorCreationGate.ProvenLoadStateReplay, gates.Snapshot().FirstFailingGate);
    }

    [TestMethod]
    public async Task SyntheticStep24ReplayThenExactHarmonyProcessorCreationPasses()
    {
        var names = CreateNames();
        using var temp = new TempTestDirectory("sts2-step26-tests");
        ...
        StringAssert.Contains(gateE.Detail, "Harmony type initializer executed by Step 26: NO");
        ...
        StringAssert.Contains(gateH.Detail, ControlledHarmonyProcessorCreation.HarmonyId);
    ...
    [TestMethod]
    public async Task GateARejectsReachablePInvokeBeforeAnyStep26ClrLoad()
    {
        var names = CreateNames();
        using var temp = new TempTestDirectory("sts2-step26-tests");
    ...
    [TestMethod]
    public async Task GateARejectsFunctionPointerIndirectionBeforeAnyStep26ClrLoad()
    {
        var names = CreateNames();
        using var temp = new TempTestDirectory("sts2-step26-tests");
    ...
    [TestMethod]
    public async Task GateARejectsImplicitTypeInitializerPInvokeBeforeAnyStep26ClrLoad()
    {
        var names = CreateNames();
        using var temp = new TempTestDirectory("sts2-step26-tests");
    ...
    public void GateAMetadataAuditDoesNotResolveExternalBaseForNominallyLocalMemberRef()
    {
        ...
        var reader = typeof(ControlledHarmonyProcessorCreation).GetMethod(
            "ReadPreparedMetadata",
            BindingFlags.NonPublic | BindingFlags.Static)
            ?? throw new AssertFailedException("Step 26 metadata reader was not found.");
    ...
    {
        var decision = ControlledHarmonyProcessorCreation.EvaluateInitializerHazardPolicy(
            ControlledHarmonyProcessorCreation.TargetSimpleName,
            ControlledHarmonyProcessorCreation.TargetVersion,
            ControlledHarmonyProcessorCreation.ObservedMonoModLoggingDispatchHazards,
    ...
    {
        var hazards = ControlledHarmonyProcessorCreation.ObservedMonoModLoggingDispatchHazards
    ...
    public void GateAConditionalMonoModPolicyRejectsNonInertLoggingState()
    {
        ...
        var debugger = ControlledHarmonyProcessorCreation.EvaluateInitializerHazardPolicy(
            ControlledHarmonyProcessorCreation.TargetSimpleName,
            ControlledHarmonyProcessorCreation.TargetVersion,
            ControlledHarmonyProcessorCreation.ObservedMonoModLoggingDispatchHazards,
            audits,
        ...
        var environment = ControlledHarmonyProcessorCreation.EvaluateInitializerHazardPolicy(
            ControlledHarmonyProcessorCreation.TargetSimpleName,
            ControlledHarmonyProcessorCreation.TargetVersion,
            ControlledHarmonyProcessorCreation.ObservedMonoModLoggingDispatchHazards,
            audits,
        ...
        var appContext = ControlledHarmonyProcessorCreation.EvaluateInitializerHazardPolicy(
            ControlledHarmonyProcessorCreation.TargetSimpleName,
            ControlledHarmonyProcessorCreation.TargetVersion,
            ControlledHarmonyProcessorCreation.ObservedMonoModLoggingDispatchHazards,
            audits,
    ...
    [TestMethod]
    public async Task GateARejectsHarmonyTypeInitializerShapeDriftBeforeAnyStep26ClrLoad()
    {
        var names = CreateNames();
        using var temp = new TempTestDirectory("sts2-step26-tests");
    ...
    private static ControlledHarmonyProcessorCreation CreateSyntheticBoundary(string launcherRoot, SyntheticNames names)
        => new(
            launcherRoot,
            collectibleLoadContext: true,
            expectedPrimarySimpleName: names.PrimarySimpleName,
            targetSimpleName: names.TargetSimpleName,
            targetVersion: ControlledHarmonyProcessorCreation.TargetVersion,
    ...
    private static SyntheticNames CreateNames()
    {
        ...
        return new SyntheticNames(
            "StS2Launcher.Step26.SyntheticPrimary." + suffix,
            "StS2Launcher.Step26.SyntheticHarmony." + suffix);
    }
    ...
    private static void AssertNotLoaded(string simpleName)
        => Assert.IsFalse(
            ...
            $"Synthetic Step 26 assembly '{simpleName}' was loaded before the intended gate.");
        ...
        bool driftHarmonyTypeInitializer = false)
    {
        ...
        WriteAssembly(
            ...
            new Version(0, 1, 0, 0),
            [systemLinqReference, new(names.TargetSimpleName, ControlledHarmonyProcessorCreation.TargetVersion, string.Empty)],
        ...
        ICollection<RuntimeBindingEdge> edges)
    {
        ...
        foreach (var reference in module.AssemblyReferences)
        {
            ...
            throw new AssertFailedException("Synthetic Step 26 fixture emitted an unexpected AssemblyRef: " + reference.FullName);
        }
    }
        ...
        bool driftHarmonyTypeInitializer = false)
    {
        ...
        if (initializerKind != InitializerKind.None)
        {
            if (!declaredReferences.TryGetValue("System.Runtime", out var systemRuntimeReference))
                throw new AssertFailedException("Synthetic Step 26 initializer requires predeclared System.Runtime.");
            ...
            switch (initializerKind)
            {
                ...
                case InitializerKind.PInvoke:
                    var pinvokeModule = new ModuleReference("libstep26fixture.dylib");
                ...
                case InitializerKind.TypeInitializerPInvoke:
                    var typeInitModule = new ModuleReference("libstep26fixture-typeinit.dylib");
                    assembly.MainModule.ModuleReferences.Add(typeInitModule);
                    var autoInitType = new TypeDefinition(
                        "StS2Launcher.Step26.Tests",
                        "AutoInitType",
        ...
        {
            if (!declaredReferences.TryGetValue("System.Runtime", out var systemRuntimeReference))
                throw new AssertFailedException("Synthetic Step 26 Harmony type requires predeclared System.Runtime.");
    ...
    private static void WriteExternalBaseMemberRefFixture(string path)
    {
        Directory.CreateDirectory(Path.GetDirectoryName(path)!);
        using var assembly = AssemblyDefinition.CreateAssembly(
            new AssemblyNameDefinition("SyntheticHarmony", ControlledHarmonyProcessorCreation.TargetVersion),
            "SyntheticHarmony",
            ModuleKind.Dll);
        ...
        // Step 26 must instead stop from local metadata with an unresolved-local hazard.
    ...
    private static MethodDefinition CreatePInvokeProbe(TypeReference voidType, ModuleReference nativeModule)
        => new(
            ...
            voidType)
        {
            PInvokeInfo = new PInvokeInfo(Mono.Cecil.PInvokeAttributes.CallConvCdecl, "step26_fixture_probe", nativeModule),
        };
