...
IPA="${1:-artifacts/StS2-Launcher-Step-12.3.ipa}"
...
[[ "$VERSION" == "0.0.37" ]] || { echo "ERROR: wrong Step 12.3 version: $VERSION" >&2; exit 4; }
[[ "$BUILD_VERSION" == "37" ]] || { echo "ERROR: wrong Step 12.3 build version: $BUILD_VERSION" >&2; exit 4; }
...
echo "Step 12.3 IPA verification passed."
echo "  Bundle ID: $BUNDLE_ID"
echo "  Version: $VERSION ($BUILD_VERSION)"
echo "  Architecture: arm64"
echo "  Expected device UI: STEP 12.3 — VERIFIED CACHE UPDATE TEST"
