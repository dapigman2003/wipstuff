    ...
    string? Error)
{
    ...
    {
        SteamAuthenticationOutcome.Authenticated when SessionPersisted && MobileApprovalCompleted =>
            "STEAM AUTH PASS — Guard approved + session saved",
        SteamAuthenticationOutcome.Authenticated when SessionPersisted =>
            "STEAM AUTH PASS — session saved",
