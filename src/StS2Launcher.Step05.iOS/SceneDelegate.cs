...
public sealed class SceneDelegate : UIWindowSceneDelegate
{
    ...
    {
        Console.WriteLine("Step 12.4.1: SceneDelegate.WillConnect");

        if (scene is not UIWindowScene windowScene)
        {
            Console.Error.WriteLine(
                $"Step 12.4.1: expected UIWindowScene, received {scene.GetType().FullName}");
            return;
        }
        ...
        try
        {
            ...
            Console.WriteLine("Step 12.4.1: UIWindow is key and visible");
        }
        catch (Exception ex)
        {
            Console.Error.WriteLine($"Step 12.4.1 startup exception: {ex}");
            ...
            var label = new UILabel
            {
                ...
                Text = $"STEP 12.4.1 STARTUP ERROR\n\n{ex.GetType().Name}\n{ex.Message}"
            };
