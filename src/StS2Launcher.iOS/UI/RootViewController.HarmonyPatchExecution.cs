...
public sealed partial class RootViewController
{
    ...
    private async Task RunControlledHarmonyPatchExecutionAsync()
    {
        ...
        try
        {
            ...
            _statusLabel.Text = "STEP 27 GATE T — PATCH-ENGINE RUNTIME BOUNDARY: measure host dynamic-code preflight, measure HarmonySharedState runtime reflection, explicitly initialize shared state, then invoke PatchProcessor.Patch() exactly once. Target is not invoked yet.";
