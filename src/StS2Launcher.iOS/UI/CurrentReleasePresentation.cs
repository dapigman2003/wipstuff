...
internal static class CurrentReleasePresentation
{
    public const string StepTitle =
        "STEP 35.0.29 — EXACT AUTHORITY CLOSURE + GATE D FINALIZATION";
    ...
    public const string Summary =
        "Physical 0.0.149 completed diagnostic Gate C end-to-end and reached Gate D. 0.0.150 introduced durable Gate-D finalization boundaries plus EXACT-CLOSURE. Codemagic 0.0.151 passed 899/899 static + 214/214 host + Step-15 native-link preflight, then iOS compile exposed that Step35DiagnosticMode is declared in StS2Launcher.Core rather than the attempted StS2Launcher.Core.Runtime namespace. Step 35.0.29 / 0.0.152 corrects only that declared-namespace import while preserving the exact-closure bridge/runtime contract.";

    public const string InitialStatus =
        "Status: Steps 32–34 are CLOSED POSITIVE at 4/4 and Step 35 remains OPEN pending an exact-authority device result. Physical 0.0.149 proves diagnostic Gate C completes normally and reaches Gate D. Codemagic 0.0.151 proved 899/899 static, 214/214 host and native-link readiness but showed the bootstrap partial imported the folder-style namespace Core.Runtime even though Step35DiagnosticMode is declared in StS2Launcher.Core. The current 0.0.152 candidate fixes that import only; exact-closure, Gate-D finalization, resolver policy, and the pinned .NET 9.0.314 + iOS workload 9.0.314.3 cache remain unchanged.";

    public const string ExpectedDisplayVersion = "0.0.152";
    public const string ExpectedBuildVersion = "152";
