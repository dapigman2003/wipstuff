...
internal static class CurrentReleasePresentation
{
    public const string StepTitle =
        "STEP 35.0.32 / STEP 36.0.3 — MODELDB BOOTSTRAP COMPATIBILITY + FULL EXECUTEESSENTIAL";
