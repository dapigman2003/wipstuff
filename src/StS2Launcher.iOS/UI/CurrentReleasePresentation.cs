...
internal static class CurrentReleasePresentation
{
    public const string StepTitle =
        "STEP 35.0.31 / STEP 36.0.1 — EXACT GAME RESOURCE-PACK HANDOFF + CONTROLLED EXECUTEESSENTIAL";

    public const string MilestoneLine =
        "STEPS 01–26 CLOSED • STEP 27 CLOSED NEGATIVE • STEP 28 CLOSED POSITIVE 5/5 • STEP 29 CLOSED POSITIVE 4/4 • STEP 30 CLOSED POSITIVE 4/4 • STEP 31 CLOSED POSITIVE 4/4 • STEP 32 CLOSED POSITIVE 4/4 • STEP 33 CLOSED POSITIVE 4/4 • STEP 34 CLOSED POSITIVE 4/4 • STEP 35 EXACT CORE CLOSURE POSITIVE • STEP 36 OPEN — RESOURCE-PACK HANDOFF";

    public const string Summary =
        "Physical 0.0.154 confirms the Step-35 completion architecture is no longer blocking progression: Step 36 started and its own explicit-main-thread teardown reached RUN_END normally. Step 36 Gate A and Gate B passed, then the first exact ExecuteEssential invocation failed deterministically with MegaCrit.Sts2.Core.Localization.LocException: Path does not exist: res://localization/eng. This is an architectural resource-filesystem mismatch: source-built Godot is still running the Step-15 smoke project, while the receipt-backed game PCK has not yet been mounted into res://. 0.0.155 adds a bounded Gate-B game-resource handoff: locate the exact PCK through the just-verified Step-12 receipt, call exact GodotSharp ProjectSettings.LoadResourcePack with replaceFiles=false/offset=0, prove res://localization/eng through DirAccess.Open, then invoke the unchanged exact ExecuteEssential authority once.";

    public const string InitialStatus =
        "Status: exact Step-35 runtime/authority closure remains physically positive. Physical 0.0.154 advances Step 36 to a deterministic missing-resource boundary, not a managed resolver/native bridge failure. Step 36.0.1 reproduces the missing Godot main-pack lifecycle narrowly using the exact receipt-backed Slay the Spire 2 PCK and the already-proven exact GodotSharp/source-built-Godot bridge. ExecuteDeferred, PrewarmJit, game entry, native game loading, Harmony/MonoMod runtime patching, arbitrary resolver fallback, and replacement of existing smoke-project files remain forbidden.";

    public const string ExpectedDisplayVersion = "0.0.155";
    public const string ExpectedBuildVersion = "155";
