...
public sealed partial class RootViewController
{
    ...
    private async Task RunTransformedRealStS2SceneTreeAdmissionAsync()
    {
        ...
        try
        {
            ...
            _statusLabel.Text = "STEP 39.0 COMPLETE — 4/4. Real SceneTree admission is physically closed with rendering frozen. In this Step-40 candidate, the only authorized same-process continuation is Step 40.1; otherwise preserve reports and relaunch.";
            _statusLabel.TextColor = UIColor.Label;
