...
/// <summary>
/// Step 05.10 retains the Step 05.8 below-SteamKit handler regression probe.
///
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        else
        {
            try
            {
                ...
                // This overload is the important Step 05.10 boundary: it forces
                ...
                if (socket.State == WebSocketState.Open)
                {
                    try
                    {
                        ...
                        await socket.CloseAsync(
                            ...
                            "Step 05.10 handler isolation complete",
