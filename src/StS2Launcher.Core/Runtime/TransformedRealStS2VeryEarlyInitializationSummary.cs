    ...
    IReadOnlyList<TransformedRealStS2VeryEarlyInitializationGateResult> Gates)
{
    ...
    public string Summary => Passed
        ? "STEP 35.0.18 DIAGNOSTIC LOCALIZATION COMPLETE — 4/4 — NOT STEP 35 CLOSURE"
        : $"STEP 35.0.18 DIAGNOSTIC LOCALIZATION {(FirstFailingGate is null ? "INCOMPLETE" : "FAIL")} — {Gates.Count(g => g.Passed)}/4";
}
