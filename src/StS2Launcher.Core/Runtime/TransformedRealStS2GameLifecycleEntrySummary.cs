    ...
    IReadOnlyList<TransformedRealStS2GameLifecycleEntryGateResult> Gates)
{
    ...
    public string Summary => Passed
        ? "STEP 38.2 IOS/OFFTREE-COMPAT NGAME _ENTERTREE ENTRY COMPLETE — 4/4"
        : $"STEP 38.2 IOS/OFFTREE-COMPAT NGAME _ENTERTREE ENTRY {(FirstFailingGate is null ? "INCOMPLETE" : "FAIL")} — {Gates.Count(g => g.Passed)}/4";
}
