    ...
    IReadOnlyList<TransformedRealStS2GameSceneAdmissionGateResult> Gates)
{
    ...
    public string Summary => Passed
        ? "STEP 37.0 CONTROLLED GAME-SCENE ADMISSION COMPLETE — 4/4"
        : $"STEP 37.0 CONTROLLED GAME-SCENE ADMISSION {(FirstFailingGate is null ? "INCOMPLETE" : "FAIL")} — {Gates.Count(g => g.Passed)}/4";
}
