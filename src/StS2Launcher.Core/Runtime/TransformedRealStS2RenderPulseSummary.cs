    ...
    IReadOnlyList<TransformedRealStS2RenderPulseGateResult> Gates)
{
    ...
    public string Summary => Passed
        ? "STEP 40.0 CONTROLLED REAL-GAME RENDER PULSE COMPLETE — 4/4"
        : $"STEP 40.0 CONTROLLED REAL-GAME RENDER PULSE {(FirstFailingGate is null ? "INCOMPLETE" : "FAIL")} — {Gates.Count(g => g.Passed)}/4";
}
