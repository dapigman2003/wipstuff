...
/// <summary>
/// Step 05.12 diagnostics below SteamKit's CM connection layer.
///
...
public sealed class CmNetworkProbe
{
        ...
        CancellationToken cancellationToken)
    {
        ...
        try
        {
            ...
            http.DefaultRequestHeaders.UserAgent.ParseAdd("StS2Launcher-iOS-Step05.12/0.0.18");
                ...
                if (socket.State == WebSocketState.Open)
                {
                    try
                    {
                        ...
                        await socket.CloseAsync(
                            ...
                            "Step 05.12 network probe complete",
