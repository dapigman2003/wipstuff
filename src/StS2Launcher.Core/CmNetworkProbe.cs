...
/// <summary>
/// Step 05.13 diagnostics below SteamKit's CM connection layer.
///
...
public sealed class CmNetworkProbe
{
        ...
        CancellationToken cancellationToken)
    {
        ...
        try
        {
            ...
            http.DefaultRequestHeaders.UserAgent.ParseAdd("StS2Launcher-iOS-Step05.13/0.0.19");
                ...
                if (socket.State == WebSocketState.Open)
                {
                    try
                    {
                        ...
                        await socket.CloseAsync(
                            ...
                            "Step 05.13 network probe complete",
