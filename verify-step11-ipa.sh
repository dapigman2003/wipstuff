...
IPA="${1:-artifacts/StS2-Launcher-Step-11.ipa}"
...
[[ "$VERSION" == "0.0.32" ]] || { echo "ERROR: wrong Step 11 version: $VERSION" >&2; exit 4; }
[[ "$BUILD_VERSION" == "32" ]] || { echo "ERROR: wrong Step 11 build version: $BUILD_VERSION" >&2; exit 4; }
...
echo "Step 11 IPA verification passed."
echo "  Bundle ID: $BUNDLE_ID"
echo "  Version: $VERSION ($BUILD_VERSION)"
echo "  Architecture: arm64"
echo "  Expected device UI: STEP 11 — INTERRUPTED-DOWNLOAD RESUME"
