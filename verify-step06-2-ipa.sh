...
IPA="${1:-artifacts/StS2-Launcher-Step-06.2.ipa}"
...
[[ "$VERSION" == "0.0.25" ]] || { echo "ERROR: wrong Step 06.2 version: $VERSION" >&2; exit 4; }
[[ "$BUILD_VERSION" == "25" ]] || { echo "ERROR: wrong Step 06.2 build version: $BUILD_VERSION" >&2; exit 4; }
...
echo "Step 06.2 IPA verification passed."
echo "  Bundle ID: $BUNDLE_ID"
echo "  Version: $VERSION ($BUILD_VERSION)"
echo "  Architecture: arm64"
echo "  Expected device UI: STEP 06.2 — KEYCHAIN SESSION RESUME"
