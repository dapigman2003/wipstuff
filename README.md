...
Active candidate: **0.0.186 (186)**. Physical runtime authority remains closed through **Step 52 4/4**; this build opens only the next single-player menu layer and keeps Step 58+ unopened.
