...
Steps 01–22 are physically closed on iPhone. Step 22.4 is a behavior-neutral canonicalization candidate before the first controlled real `sts2.dll` CLR load.
